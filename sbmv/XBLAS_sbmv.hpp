...
//static const char routine_name[] = "XBLAS::sbmv_x";
  ...
  case blas_prec_single:
    XBLAS::sbmv<T, A, X, impl::internal_precision_t<T, blas_prec_single>, IdxType>(order, uplo, n, k, alpha, a, lda, x, incx, beta, y, incy);
    break;
  case blas_prec_double:
    XBLAS::sbmv<T, A, X, impl::internal_precision_t<T, blas_prec_double>, IdxType>(order, uplo, n, k, alpha, a, lda, x, incx, beta, y, incy);
    break;
  case blas_prec_indigenous:
    XBLAS::sbmv<T, A, X, impl::internal_precision_t<T, blas_prec_indigenous>, IdxType>(order, uplo, n, k, alpha, a, lda, x, incx, beta, y, incy);
    break;
  case blas_prec_extra:
    XBLAS::sbmv<T, A, X, impl::internal_precision_t<T, blas_prec_extra>, IdxType>(order, uplo, n, k, alpha, a, lda, x, incx, beta, y, incy);
    break;
  }
} /* end XBLAS::sbmv_x */
