...
void BLAS_zhemm_x(enum blas_order_type order,
 ...
 */
{
//static const char routine_name[] = "BLAS_zhemm_x";
#if 1
  XBLAS::hemm_x(order,
                side,
                uplo,
            ...
            for (j = 0, cij = ci, bj = 0; j < n_i;
              ...
              for (k = 0, aik = ai, bkj = bj; k < i;
                ...
                }
                {
                  ...
                  double head_t2, tail_t2;
                  /* Real part */
                  compute_doubledouble_eq_double_mul_double(&head_t1, &tail_t1, a_elem[0], b_elem[0]);
                  compute_doubledouble_eq_double_mul_double(&head_t2, &tail_t2, a_elem[1], b_elem[1]);
                  head_t2 = -head_t2;
                  tail_t2 = -tail_t2;
                  compute_doubledouble_eq_doubledouble_add_doubledouble(&head_t1, &tail_t1, head_t1, tail_t1, head_t2, tail_t2);
                  head_prod[0] = head_t1;
                  tail_prod[0] = tail_t1;
                  /* Imaginary part */
                  compute_doubledouble_eq_double_mul_double(&head_t1, &tail_t1, a_elem[1], b_elem[0]);
                  compute_doubledouble_eq_double_mul_double(&head_t2, &tail_t2, a_elem[0], b_elem[1]);
                  compute_doubledouble_eq_doubledouble_add_doubledouble(&head_t1, &tail_t1, head_t1, tail_t1, head_t2, tail_t2);
                  head_prod[1] = head_t1;
                  tail_prod[1] = tail_t1;
                }
