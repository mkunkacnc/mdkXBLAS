...
void BLAS_zhemv_x(enum blas_order_type order,
 ...
 */
{
//static const char routine_name[] = "BLAS_zhemv_x";
#if 0
  XBLAS::hemv_x(order,
                uplo,
                n,
            ...
            if (beta_i[0] == 0.0 && beta_i[1] == 0.0) {
              ...
              for (i = 0, yi = y_starti, astarti = 0;
                ...
                x_elem[1] = x_i[xi + 1];
                {
                  ...
                  double head_t, tail_t;
                  compute_doubledouble_eq_double_mul_double(&head_t, &tail_t, a_elem[0], x_elem[0]);
                  head_prod[0] = head_t;
                  tail_prod[0] = tail_t;
                  compute_doubledouble_eq_double_mul_double(&head_t, &tail_t, a_elem[0], x_elem[1]);
                  head_prod[1] = head_t;
                  tail_prod[1] = tail_t;
                }
                {
