...
void BLAS_zsymm_d_z_x(enum blas_order_type order,
 ...
 */
{
//static const char routine_name[] = "BLAS_zsymm_d_z_x";
#if 0
  XBLAS::symm_x(order,
                side,
                uplo,
            ...
            for (j = 0, cij = ci, bj = 0; j < n_i;
              ...
              for (k = 0, aik = ai, bkj = bj; k < i;
                ...
                b_elem[1] = b_i[bkj + 1];
                {
                  ...
                  compute_doubledouble_eq_double_mul_double(&head_t, &tail_t, a_elem, b_elem[0]);
                  head_prod[0] = head_t;
                  tail_prod[0] = tail_t;
                  compute_doubledouble_eq_double_mul_double(&head_t, &tail_t, a_elem, b_elem[1]);
                  head_prod[1] = head_t;
                  tail_prod[1] = tail_t;
                }
                {
