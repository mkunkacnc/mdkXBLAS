...
void BLAS_zdot_x(enum blas_conj_type conj,
                 int n,
                 const void *alpha,
                 const void *x,
                 int incx,
      ...
      if (conj == blas_conj) {
        for (i = 0; i < n; ++i) {
          ...
          x_ii[1] = -x_ii[1];
          {
            ...
            /* Real part */
            compute_doubledouble_eq_double_mul_double(&head_t1, &tail_t1, x_ii[0], y_ii[0]);
            compute_doubledouble_eq_double_mul_double(&head_t2, &tail_t2, x_ii[1], y_ii[1]);
            head_t2 = -head_t2;
            tail_t2 = -tail_t2;
            ...
            tail_prod[0] = tail_t1;
            /* Imaginary part */
            compute_doubledouble_eq_double_mul_double(&head_t1, &tail_t1, x_ii[1], y_ii[0]);
            compute_doubledouble_eq_double_mul_double(&head_t2, &tail_t2, x_ii[0], y_ii[1]);
            compute_doubledouble_eq_doubledouble_add_doubledouble(&head_t1, &tail_t1, head_t1, tail_t1, head_t2, tail_t2);
            head_prod[1] = head_t1;
            tail_prod[1] = tail_t1;
          }                        /* prod = x[i]*y[i] */
