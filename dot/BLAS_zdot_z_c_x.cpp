...
void BLAS_zdot_z_c_x(enum blas_conj_type conj,
                     int n,
                     const void *alpha,
                     const void *x,
                     int incx,
        ...
        for (i = 0; i < n; ++i) {
          ...
          x_ii[1] = -x_ii[1];
          {
            ...
            cd[1] = (double) y_ii[1];
            {
              ...
              /* Real part */
              compute_doubledouble_eq_double_mul_double(&head_t1, &tail_t1, x_ii[0], cd[0]);
              compute_doubledouble_eq_double_mul_double(&head_t2, &tail_t2, x_ii[1], cd[1]);
              head_t2 = -head_t2;
              tail_t2 = -tail_t2;
              ...
              tail_prod[0] = tail_t1;
              /* Imaginary part */
              compute_doubledouble_eq_double_mul_double(&head_t1, &tail_t1, x_ii[1], cd[0]);
              compute_doubledouble_eq_double_mul_double(&head_t2, &tail_t2, x_ii[0], cd[1]);
              compute_doubledouble_eq_doubledouble_add_doubledouble(&head_t1, &tail_t1, head_t1, tail_t1, head_t2, tail_t2);
              head_prod[1] = head_t1;
              tail_prod[1] = tail_t1;
            }
