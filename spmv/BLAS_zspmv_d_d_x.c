              ...
              if (beta_i[0] == 0.0 && beta_i[1] == 0.0) {
                {
                  ...
                  for (matrix_row = 0; matrix_row < n; matrix_row++) {
                    ...
                    for (step = 0; step < matrix_row; step++) {
                      matval = ap_i[ap_index];
                      vecval = x_i[x_index];
                      compute_doubledouble_eq_double_mul_double(&head_rowtmp, &tail_rowtmp, matval, vecval);
              ...
              if (beta_i[0] == 0.0 && beta_i[1] == 0.0) {
                {
                  ...
                  for (matrix_row = 0; matrix_row < n; matrix_row++) {
                    ...
                    }
                    {
                      ...
                      double head_t, tail_t;
                      compute_doubledouble_eq_doubledouble_mul_double(&head_t, &tail_t, head_rowsum, tail_rowsum, alpha_i[0]);
                      head_tmp1[0] = head_t;
                      tail_tmp1[0] = tail_t;
                      compute_doubledouble_eq_doubledouble_mul_double(&head_t, &tail_t, head_rowsum, tail_rowsum, alpha_i[1]);
                      head_tmp1[1] = head_t;
                      tail_tmp1[1] = tail_t;
                    }
                    y_i[y_index] = head_tmp1[0];
