...
//static const char routine_name[] = "XBLAS::spmv_x";
  ...
  case blas_prec_single:
    XBLAS::spmv<T, A, X, impl::internal_precision_t<T, blas_prec_single>, IdxType>(order, uplo, n, alpha, ap, x, incx, beta, y, incy);
    break;
  case blas_prec_double:
    XBLAS::spmv<T, A, X, impl::internal_precision_t<T, blas_prec_double>, IdxType>(order, uplo, n, alpha, ap, x, incx, beta, y, incy);
    break;
  case blas_prec_indigenous:
    XBLAS::spmv<T, A, X, impl::internal_precision_t<T, blas_prec_indigenous>, IdxType>(order, uplo, n, alpha, ap, x, incx, beta, y, incy);
    break;
  case blas_prec_extra:
    XBLAS::spmv<T, A, X, impl::internal_precision_t<T, blas_prec_extra>, IdxType>(order, uplo, n, alpha, ap, x, incx, beta, y, incy);
    break;
  }
} /* end XBLAS::spmv_x */
