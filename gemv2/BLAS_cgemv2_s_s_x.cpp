...
void BLAS_cgemv2_s_s_x(enum blas_order_type order,
          ...
          if ((alpha_i[0] == 1.0 && alpha_i[1] == 0.0)) {
            ...
            for (i = 0; i < leny; i++) {
              ...
              }
              {
                ...
                double dt;
                dt = (double) alpha_i[0];
                compute_doubledouble_eq_doubledouble_mul_double(&head_e1, &tail_e1, head_sum2, tail_sum2, dt);
                head_tmp2[0] = head_e1;
                tail_tmp2[0] = tail_e1;
                dt = (double) alpha_i[1];
                compute_doubledouble_eq_doubledouble_mul_double(&head_e1, &tail_e1, head_sum2, tail_sum2, dt);
