...
void BLAS_zgemv2_z_c_x(enum blas_order_type order,
...
//static const char routine_name[] = "BLAS_zgemv2_z_c_x";
  ...
  XBLAS::gemv2_x(order,
                 ...
                 *static_cast<const std::complex<double> *>(alpha),
                 ...
                 lda,
                 static_cast<const std::complex<float> *>(head_x),
                 static_cast<const std::complex<float> *>(tail_x),
                 incx,
                 *static_cast<const std::complex<double> *>(beta),
                 static_cast<std::complex<double> *>(y),
                 incy,
                 prec);
} /* end BLAS_zgemv2_z_c_x */
#else
  static const char routine_name[] = "BLAS_zgemv2_z_c_x";
  switch (prec) {
