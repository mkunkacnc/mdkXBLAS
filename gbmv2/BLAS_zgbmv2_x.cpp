...
void BLAS_zgbmv2_x(enum blas_order_type order,
...
//static const char routine_name[] = "BLAS_zgbmv2_x";
  ...
  XBLAS::gbmv2_x(order,
                 ...
                 *static_cast<const std::complex<> *>(alpha),
                 ...
                 lda,
                 static_cast<const std::complex<> *>(head_x),
                 static_cast<const std::complex<> *>(tail_x),
                 incx,
        ...
        if (trans != blas_conj_trans) {
          for (j = ra - la; j >= 0; j--) {
            ...
            a_elem[1] = a_i[aij + 1];
            {
              ...
              /* Real part */
              compute_doubledouble_eq_double_mul_double(&head_t1, &tail_t1, x_elem[0], a_elem[0]);
              compute_doubledouble_eq_double_mul_double(&head_t2, &tail_t2, x_elem[1], a_elem[1]);
              head_t2 = -head_t2;
              tail_t2 = -tail_t2;
              ...
              tail_prod[0] = tail_t1;
              /* Imaginary part */
              compute_doubledouble_eq_double_mul_double(&head_t1, &tail_t1, x_elem[1], a_elem[0]);
              compute_doubledouble_eq_double_mul_double(&head_t2, &tail_t2, x_elem[0], a_elem[1]);
              compute_doubledouble_eq_doubledouble_add_doubledouble(&head_t1, &tail_t1, head_t1, tail_t1, head_t2, tail_t2);
              head_prod[1] = head_t1;
              tail_prod[1] = tail_t1;
            }
