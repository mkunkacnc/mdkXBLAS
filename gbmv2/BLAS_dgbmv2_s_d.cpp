...
void BLAS_dgbmv2_s_d(enum blas_order_type order,
 ...
 */
{
//char *routine_name = "BLAS_dgbmv2_s_d";
#if 0
  XBLAS::gbmv2(order, trans, m, n, kl, ku, alpha, a, lda, head_x, tail_x, incx, beta, y, incy);
} /* end BLAS_dgbmv2_s_d */
#else 
