...
void BLAS_stpmv_x(enum blas_order_type order,
 ...
 */
{
//char *routine_name = "BLAS_stpmv_x";
#if 0
          ...
          if ((uplo == blas_upper &&
            ...
            for (matrix_row = 0; matrix_row < n; matrix_row++) {
              ...
              }
              {
                ...
                compute_doubledouble_eq_doubledouble_mul_double(&head_result, &tail_result, head_rowsum, tail_rowsum, dt);
              }
