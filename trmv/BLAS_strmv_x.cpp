 ...
 */
{
//char *routine_name = "BLAS_strmv_x";
#if 0
        ...
        if (diag == blas_unit_diag) {
          ...
          for (i = 0; i < n; i++) {
            ...
            x_elem = x_i[xj];
            {
              ...
              compute_doubledouble_eq_doubledouble_add_double(&head_sum, &tail_sum, head_sum, tail_sum, dt);
            }
            ...
            if (alpha_i == 1.0) {
            ...
            } else {
              {
                ...
                compute_doubledouble_eq_doubledouble_mul_double(&head_tmp, &tail_tmp, head_sum, tail_sum, dt);
              }
              x_i[xj] = head_tmp;
            }
