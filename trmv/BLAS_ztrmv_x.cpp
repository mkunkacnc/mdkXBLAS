...
void BLAS_ztrmv_x(enum blas_order_type order,
...
//static const char routine_name[] = "BLAS_ztrmv_x";
  ...
  XBLAS::trmv_x(order,
                ...
                *static_cast<const std::complex<double> *>(alpha),
                static_cast<const std::complex<double> *>(T),
                ldt,
            ...
            for (i = 0; i < n; i++) {
              ...
              for (j = i; j < (n - 1); j++) {
                ...
                x_elem[1] = x_i[xj + 1];
                {
                  ...
                  /* Real part */
                  compute_doubledouble_eq_double_mul_double(&head_t1, &tail_t1, x_elem[0], t_elem[0]);
                  compute_doubledouble_eq_double_mul_double(&head_t2, &tail_t2, x_elem[1], t_elem[1]);
                  head_t2 = -head_t2;
                  tail_t2 = -tail_t2;
                  ...
                  tail_prod[0] = tail_t1;
                  /* Imaginary part */
                  compute_doubledouble_eq_double_mul_double(&head_t1, &tail_t1, x_elem[1], t_elem[0]);
                  compute_doubledouble_eq_double_mul_double(&head_t2, &tail_t2, x_elem[0], t_elem[1]);
                  compute_doubledouble_eq_doubledouble_add_doubledouble(&head_t1, &tail_t1, head_t1, tail_t1, head_t2, tail_t2);
                  head_prod[1] = head_t1;
                  tail_prod[1] = tail_t1;
                }
