...
void BLAS_ztrmv_d_x(enum blas_order_type order,
          ...
          for (i = 0; i < n; i++) {
            ...
            for (j = i; j < (n - 1); j++) {
              ...
              x_elem[1] = x_i[xj + 1];
              {
                ...
                compute_doubledouble_eq_double_mul_double(&head_t, &tail_t, t_elem, x_elem[0]);
                head_prod[0] = head_t;
                tail_prod[0] = tail_t;
                compute_doubledouble_eq_double_mul_double(&head_t, &tail_t, t_elem, x_elem[1]);
                head_prod[1] = head_t;
                tail_prod[1] = tail_t;
              }
              {
