...
void BLAS_zge_sum_mv_z_c_x(enum blas_order_type order,
                           int m,
                           int n,
                           const void *alpha,
                           const void *a,
            ...
            for (j = 0, xi = x_starti; j < n; j++, xi += incxi) {
              ...
              b_elem[1] = b_i[bij + 1];
              {
                ...
                cd[1] = (double) x_elem[1];
                {
                  ...
                  /* Real part */
                  compute_doubledouble_eq_double_mul_double(&head_t1, &tail_t1, b_elem[0], cd[0]);
                  compute_doubledouble_eq_double_mul_double(&head_t2, &tail_t2, b_elem[1], cd[1]);
                  head_t2 = -head_t2;
                  tail_t2 = -tail_t2;
                  ...
                  tail_prod[0] = tail_t1;
                  /* Imaginary part */
                  compute_doubledouble_eq_double_mul_double(&head_t1, &tail_t1, b_elem[1], cd[0]);
                  compute_doubledouble_eq_double_mul_double(&head_t2, &tail_t2, b_elem[0], cd[1]);
                  compute_doubledouble_eq_doubledouble_add_doubledouble(&head_t1, &tail_t1, head_t1, tail_t1, head_t2, tail_t2);
                  head_prod[1] = head_t1;
                  tail_prod[1] = tail_t1;
                }
