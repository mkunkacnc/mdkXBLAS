...
void BLAS_cge_sum_mv_s_s_x(enum blas_order_type order,
                           int m,
                           int n,
                           const void *alpha,
                           const float *a,
 ...
 */
{
//static const char routine_name[] = "BLAS_cge_sum_mv_s_s_x";
#if 1
        ...
        if (beta_i[0] == 0.0 && beta_i[1] == 0.0) {
          ...
          for (i = 0, yi = y_starti; i < m; i++, yi += incyi) {
            ...
            /* now put the result into y_i */
            {
              ...
              double dt;
              dt = (double) beta_i[0];
              compute_doubledouble_eq_doubledouble_mul_double(&head_e1, &tail_e1, head_sumB, tail_sumB, dt);
              head_tmp1[0] = head_e1;
              tail_tmp1[0] = tail_e1;
              dt = (double) beta_i[1];
              compute_doubledouble_eq_doubledouble_mul_double(&head_e1, &tail_e1, head_sumB, tail_sumB, dt);
        ...
        if (beta_i[0] == 0.0 && beta_i[1] == 0.0) {
          ...
          for (i = 0, yi = y_starti; i < m; i++, yi += incyi) {
            ...
            /* now put the result into y_i */
            {
              ...
              double dt;
              dt = (double) alpha_i[0];
              compute_doubledouble_eq_doubledouble_mul_double(&head_e1, &tail_e1, head_sumA, tail_sumA, dt);
              head_tmp1[0] = head_e1;
              tail_tmp1[0] = tail_e1;
              dt = (double) alpha_i[1];
              compute_doubledouble_eq_doubledouble_mul_double(&head_e1, &tail_e1, head_sumA, tail_sumA, dt);
