        ...
        if (beta_i[0] == 0.0 && beta_i[1] == 0.0) {
          ...
          for (i = 0, yi = y_starti; i < m; i++, yi += incyi) {
            ...
            for (j = 0, xi = x_starti; j < n; j++, xi += incxi) {
              ...
              b_elem[1] = b_i[bij + 1];
              {
                ...
                /* Real part */
                compute_doubledouble_eq_double_mul_double(&head_t1, &tail_t1, b_elem[0], x_elem[0]);
                compute_doubledouble_eq_double_mul_double(&head_t2, &tail_t2, b_elem[1], x_elem[1]);
                head_t2 = -head_t2;
                tail_t2 = -tail_t2;
                ...
                tail_prod[0] = tail_t1;
                /* Imaginary part */
                compute_doubledouble_eq_double_mul_double(&head_t1, &tail_t1, b_elem[1], x_elem[0]);
                compute_doubledouble_eq_double_mul_double(&head_t2, &tail_t2, b_elem[0], x_elem[1]);
                compute_doubledouble_eq_doubledouble_add_doubledouble(&head_t1, &tail_t1, head_t1, tail_t1, head_t2, tail_t2);
                head_prod[1] = head_t1;
                tail_prod[1] = tail_t1;
              }
          ...
          for (i = 0, yi = y_starti; i < m; i++, yi += incyi) {
            ...
            /* now put the result into y_i */
            {
              ...
              tail_a1 = tail_sumB[1];
              /* real part */
              compute_doubledouble_eq_doubledouble_mul_double(&head_t1, &tail_t1, head_a0, tail_a0, beta_i[0]);
              compute_doubledouble_eq_doubledouble_mul_double(&head_t2, &tail_t2, head_a1, tail_a1, beta_i[1]);
              head_t2 = -head_t2;
              tail_t2 = -tail_t2;
              compute_doubledouble_eq_doubledouble_add_doubledouble(&head_t1, &tail_t1, head_t1, tail_t1, head_t2, tail_t2);
              head_tmp1[0] = head_t1;
              tail_tmp1[0] = tail_t1;
              /* imaginary part */
              compute_doubledouble_eq_doubledouble_mul_double(&head_t1, &tail_t1, head_a1, tail_a1, beta_i[0]);
              compute_doubledouble_eq_doubledouble_mul_double(&head_t2, &tail_t2, head_a0, tail_a0, beta_i[1]);
              compute_doubledouble_eq_doubledouble_add_doubledouble(&head_t1, &tail_t1, head_t1, tail_t1, head_t2, tail_t2);
              head_tmp1[1] = head_t1;
              tail_tmp1[1] = tail_t1;
            }
          ...
          for (i = 0, yi = y_starti; i < m; i++, yi += incyi) {
            ...
            for (j = 0, xi = x_starti; j < n; j++, xi += incxi) {
              ...
              a_elem[1] = a_i[aij + 1];
              {
                ...
                double head_t2, tail_t2;
                /* Real part */
                compute_doubledouble_eq_double_mul_double(&head_t1, &tail_t1, a_elem[0], x_elem[0]);
                compute_doubledouble_eq_double_mul_double(&head_t2, &tail_t2, a_elem[1], x_elem[1]);
                head_t2 = -head_t2;
                tail_t2 = -tail_t2;
                compute_doubledouble_eq_doubledouble_add_doubledouble(&head_t1, &tail_t1, head_t1, tail_t1, head_t2, tail_t2);
                head_prod[0] = head_t1;
                tail_prod[0] = tail_t1;
                /* Imaginary part */
                compute_doubledouble_eq_double_mul_double(&head_t1, &tail_t1, a_elem[1], x_elem[0]);
                compute_doubledouble_eq_double_mul_double(&head_t2, &tail_t2, a_elem[0], x_elem[1]);
                compute_doubledouble_eq_doubledouble_add_doubledouble(&head_t1, &tail_t1, head_t1, tail_t1, head_t2, tail_t2);
                head_prod[1] = head_t1;
                tail_prod[1] = tail_t1;
              }
