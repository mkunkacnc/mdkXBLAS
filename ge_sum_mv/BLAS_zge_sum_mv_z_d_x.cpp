...
void BLAS_zge_sum_mv_z_d_x(enum blas_order_type order,
                           int m,
                           int n,
                           const void *alpha,
                           const void *a,
 ...
 */
{
//static const char routine_name[] = "BLAS_zge_sum_mv_z_d_x";
#if 0
          ...
          for (i = 0, yi = y_starti; i < m; i++, yi += incyi) {
            ...
            for (j = 0, xi = x_starti; j < n; j++, xi += incxi) {
              ...
              b_elem[1] = b_i[bij + 1];
              {
                ...
                compute_doubledouble_eq_double_mul_double(&head_t, &tail_t, x_elem, b_elem[0]);
                head_prod[0] = head_t;
                tail_prod[0] = tail_t;
                compute_doubledouble_eq_double_mul_double(&head_t, &tail_t, x_elem, b_elem[1]);
                head_prod[1] = head_t;
                tail_prod[1] = tail_t;
              }
              {
