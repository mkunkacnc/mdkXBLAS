...
void BLAS_zhpmv_z_c_x(enum blas_order_type order,
                      ...
                      for (step = 0; step < matrix_row; step++) {
                        ...
                        matval[1] = -matval[1];
                        {
                          ...
                          cd[1] = (double) vecval[1];
                          {
                            ...
                            double head_t2, tail_t2;
                            /* Real part */
                            compute_doubledouble_eq_double_mul_double(&head_t1, &tail_t1, matval[0], cd[0]);
                            compute_doubledouble_eq_double_mul_double(&head_t2, &tail_t2, matval[1], cd[1]);
                            head_t2 = -head_t2;
                            tail_t2 = -tail_t2;
                            compute_doubledouble_eq_doubledouble_add_doubledouble(&head_t1, &tail_t1, head_t1, tail_t1, head_t2, tail_t2);
                            ...
                            /* Imaginary part */
                            compute_doubledouble_eq_double_mul_double(&head_t1, &tail_t1, matval[1], cd[0]);
                            compute_doubledouble_eq_double_mul_double(&head_t2, &tail_t2, matval[0], cd[1]);
                            compute_doubledouble_eq_doubledouble_add_doubledouble(&head_t1, &tail_t1, head_t1, tail_t1, head_t2, tail_t2);
