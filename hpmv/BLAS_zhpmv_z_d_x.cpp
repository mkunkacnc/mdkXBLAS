...
void BLAS_zhpmv_z_d_x(enum blas_order_type order,
                    ...
                    for (matrix_row = 0; matrix_row < n; matrix_row++) {
                      ...
                      for (step = 0; step < matrix_row; step++) {
                        ...
                        matval[1] = -matval[1];
                        {
                          ...
                          compute_doubledouble_eq_double_mul_double(&head_t, &tail_t, vecval, matval[0]);
                          head_rowtmp[0] = head_t;
                          tail_rowtmp[0] = tail_t;
                          compute_doubledouble_eq_double_mul_double(&head_t, &tail_t, vecval, matval[1]);
