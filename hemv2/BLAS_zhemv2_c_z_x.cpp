...
#include <blas_fpu.h>
void BLAS_zhemv2_c_z_x(enum blas_order_type order,
 ...
 */
{
//static const char routine_name[] = "BLAS_zhemv2_c_z_x";
#if 0
  XBLAS::hemv2_x(order,
                 uplo,
                 n,
        ...
        for (i = 0, yi = yi0, ai = 0; i < n; i++, yi += incy, ai += incai) {
          ...
          x_elem[1] = x_head_i[xi + 1];
          {
            double dt = (double) diag_elem;
            {
              ...
              double head_t, tail_t;
              compute_doubledouble_eq_double_mul_double(&head_t, &tail_t, dt, x_elem[0]);
              head_prod1[0] = head_t;
              tail_prod1[0] = tail_t;
              compute_doubledouble_eq_double_mul_double(&head_t, &tail_t, dt, x_elem[1]);
              head_prod1[1] = head_t;
              tail_prod1[1] = tail_t;
            }
          }
