...
void BLAS_zhemv2_x(enum blas_order_type order,
 ...
 */
{
//static const char routine_name[] = "BLAS_zhemv2_x";
#if 0
  XBLAS::hemv2_x(order,
                 uplo,
                 n,
                 *static_cast<const std::complex<double> *>(alpha),
                 ...
                 lda,
                 static_cast<const std::complex<double> *>(x_head),
      ...
      if (uplo == blas_lower) {
        for (i = 0, yi = yi0, ai = 0; i < n; i++, yi += incy, ai += incai) {
          ...
          x_elem[1] = x_head_i[xi + 1];
          {
            ...
            double head_t, tail_t;
            compute_doubledouble_eq_double_mul_double(&head_t, &tail_t, diag_elem, x_elem[0]);
            head_prod1[0] = head_t;
            tail_prod1[0] = tail_t;
            compute_doubledouble_eq_double_mul_double(&head_t, &tail_t, diag_elem, x_elem[1]);
            head_prod1[1] = head_t;
            tail_prod1[1] = tail_t;
          }
          {
