 ...
 */
{
//static const char routine_name[] = "BLAS_zhemv2_z_d_x";
#if 0
  XBLAS::hemv2_x(order,
                 uplo,
                 n,
  ...
  case blas_prec_extra:{
      ...
      if (uplo == blas_lower) {
        for (i = 0, yi = yi0, ai = 0; i < n; i++, yi += incy, ai += incai) {
          ...
          diag_elem = a_i[aij];
          x_elem = x_head_i[xi];
          compute_complex_double_double_eq_double_mul_double(head_prod1, tail_prod1, x_elem, diag_elem);
          {
            double head_t, tail_t;
            double head_a, tail_a;
            double head_b, tail_b;
          ...
          x_elem = x_tail_i[xi];
          compute_complex_double_double_eq_double_mul_double(head_prod2, tail_prod2, x_elem, diag_elem);
          {
            double head_t, tail_t;
            double head_a, tail_a;
            double head_b, tail_b;
