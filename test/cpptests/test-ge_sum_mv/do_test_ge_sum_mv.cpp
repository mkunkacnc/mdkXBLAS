...
int main_ge_sum_mv(int argc, const char **argv)
#else
...
#endif
{
  ...
  if (nsizes < 0 || ntests < 0 || debug < 0 || debug > 3)
    BLAS_error("Testing ge_sum_mv", 0, 0, nullptr);
