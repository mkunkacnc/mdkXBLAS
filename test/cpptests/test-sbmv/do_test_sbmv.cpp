...
int main_sbmv(int argc, const char **argv)
#else
...
#endif
{
  ...
  if (nsizes < 0 || ntests < 0 || debug < 0 || debug > 3)
    BLAS_error("Testing sbmv", 0, 0, nullptr);
