...
int main_symv(int argc, const char **argv)
#else
...
#endif
{
  ...
  if (nsizes < 0 || ntests < 0 || debug < 0 || debug > 3)
    BLAS_error("Testing symv", 0, 0, nullptr);
