 ...
 */
{
  ...
  *min_ratio = 0.0;
  ...
  if (max_mn * 2 > 0 && head_x == nullptr) {
    BLAS_error("blas_malloc", 0, 0, "malloc failed.\n");
  }
  tail_x = (float *) blas_malloc(max_mn * 2 * sizeof(float));
  if (max_mn * 2 > 0 && tail_x == nullptr) {
    BLAS_error("blas_malloc", 0, 0, "malloc failed.\n");
  }
  ...
  if (max_mn > 0 && head_x_gen == nullptr) {
    BLAS_error("blas_malloc", 0, 0, "malloc failed.\n");
  }
  tail_x_gen = (float *) blas_malloc(max_mn * sizeof(float));
  if (max_mn > 0 && tail_x_gen == nullptr) {
    BLAS_error("blas_malloc", 0, 0, "malloc failed.\n");
  }
  ...
  if ((m - 1 + n - 1 + 1) * max_mn * 2 > 0 && A == nullptr) {
    BLAS_error("blas_malloc", 0, 0, "malloc failed.\n");
  }
...
int main_gemv2(int argc, const char **argv)
#else
...
#endif
{
  ...
  if (nsizes < 0 || ntests < 0 || debug < 0 || debug > 3)
    BLAS_error("Testing gemv2", 0, 0, nullptr);
