...
int main_dot2(int argc, const char **argv)
#else
...
#endif
{
  ...
  if (nsizes < 0 || ntests < 0 || debug < 0 || debug > 3)
    BLAS_error("Testing dot2", 0, 0, nullptr);
