                    ...
                    if (ratio > thresh) {
                      ...
                      if ((debug == 3) &&        /* print only when debug is on */
                        ...
                        for (j = 0; j < n; j++) {
                          ...
                          if (j > 0)
                            printf("        ");
                          sprint_vector(temp, n, 1, nullptr);
                        }
                    ...
                    if (ratio > thresh) {
                      ...
                      if ((debug == 3) &&        /* print only when debug is on */
                        ...
                        for (j = 0; j < n; j++) {
                          ...
                          if (j > 0)
                            printf("        ");
                          cprint_vector(temp, n, 1, nullptr);
                        }
                    ...
                    if (ratio > thresh) {
                      ...
                      if ((debug == 3) &&        /* print only when debug is on */
                        ...
                        for (j = 0; j < n; j++) {
                          ...
                          if (j > 0)
                            printf("        ");
                          dprint_vector(temp, n, 1, nullptr);
                        }
                      ...
                      if (ratio > thresh) {
                        ...
                        if ((debug == 3) &&        /* print only when debug is on */
                          ...
                          for (j = 0; j < n; j++) {
                            ...
                            if (j > 0)
                              printf("        ");
                            zprint_vector(temp, n, 1, nullptr);
                          }
...
#endif
{
  ...
  if (nsizes < 0 || ntests < 0 || debug < 0 || debug > 3)
    BLAS_error("Testing tpmv", 0, 0, nullptr);
